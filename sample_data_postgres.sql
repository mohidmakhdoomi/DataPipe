...
SELECT
    ...
    'User' || subquery.uuid,
    'Test' || subquery.uuid
    FROM (SELECT generate_series(15, 1000) as uuid) AS subquery;
...
SELECT
    ...
    FROM (SELECT generate_series(5, 1000) as uuid) AS subquery;
...
SELECT
    ...
    FROM (SELECT generate_series(4, 1000) as uuid) AS subquery;
